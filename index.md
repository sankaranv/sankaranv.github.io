...
I am a first-year MS student at the [College of Information and Computer Sciences, UMass Amherst](https://www.cics.umass.edu/), where I currently work with the [https://groups.cs.umass.edu/kdl/](Knowledge Discovery Lab). My primary research interest is in explainable artificial intelligence. My research lies at the intersection of Machine Learning, Causal Inference and Network Science.
